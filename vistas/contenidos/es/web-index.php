<div class="banner">
    <div class="banner-body">
        ...
        <p>LOS MEJORES PRODUCTOS PARA TU NOVIA O MOZAS :D SOLO EN: <?php echo COMPANY; ?></p>
    </div>
</div>
...
<div class="container container-web-page">
    <div class="row justify-content-md-center">
        ...
        <div class="w-100"></div>
        <div class="col-12 col-md-6">
            <h3 class="text-center text-uppercase poppins-regular font-weight-bold">Crea tu cuenta & se parte de la familia</h3>
